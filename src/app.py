...
# Using the code in the instructions file but not as a function
...
# Engine no longer offers execute functionalities. This feature has been deprecated. Using another method (need to import text from sqlalchemy)
connection.execute(text("""CREATE TABLE publishers(
...
# 3) Execute the SQL sentences to insert your data using the SQLAlchemy's execute function, again with a different method for it to work with this version of sqlalchemy
...
dataframe = pd.read_sql("SELECT * FROM authors;", connection) #Using connection variable here instead of engine
print(dataframe)